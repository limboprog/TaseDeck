...
var glassSurfaceStyle = {
  background: `linear-gradient(180deg, ${colors2.glassFillTop} 0%, ${colors2.glassFillBottom} 100%)`,
  backdropFilter: "blur(20px) saturate(105%)",
  WebkitBackdropFilter: "blur(20px) saturate(105%)",
  boxShadow: [
    `inset 0 1px 0 ${colors2.glassEdgeTop}`,
    `inset 0 0 0 1px ${whiteAlpha[2]}`,
    `inset 0 0 40px ${colors2.glassInnerGlow}`,
    `inset 0 0 100px ${colors2.glassInnerDepth}`,
    `var(--td-shadow-shell)`
  ].join(", ")
};
var glassGlowStyle = {
...
var solidPanelSurfaceStyle = {
  background: colors2.surface
};
var shellSurfaceStyle = {
  background: colors2.page,
...
var tamaguiThemeBase = {
  background: colors2.background,
  backgroundHover: surfaces.control,
  backgroundPress: surfaces.controlHover,
  backgroundFocus: colors2.page,
  backgroundStrong: colors2.surface,
  color: colors2.foreground,
  colorHover: colors2.foreground,
  colorPress: colors2.muted,
  colorFocus: colors2.foreground,
  borderColor: colors2.border,
  borderColorHover: colors2.border,
  placeholderColor: colors2.muted,
  accent: colors2.accent,
  accentColor: colors2.accent
};
